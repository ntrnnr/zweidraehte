...
// The mock IP platform is shared across all KNX/IP device demos and
// re-exported here so existing `mdt_push_button_lite::MockIpPlatform`
// paths keep resolving.
pub use crate::mock_platform::MockIpPlatform;
...
// The always-identical System B stack shell is generated by
// `system_b_standard_stack!`; only the device-specific bill of materials
// (UDP feature set, MDT params/comm-objects) is spelled out here.
zweidraehte_device::system_b_standard_stack! {
    stack: MdtStack,
    device: &DEVICE_DESCRIPTOR,
    tl_style: TlStyle::Style1,
    params: MdtParams,
    com_objects: comm_objs::MdtComObjects,
    link_layer_builder: KnxNetIpBuilder<MdtStack>,
