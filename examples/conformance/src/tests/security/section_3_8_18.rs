...
const SECURE_WRITE_SUBNET: &str = "3C 60 #EDI #BDUT_ADDR 0A 01 CE 00 00 00 10 39 01 00 01 72";
...
const SECURE_WRITE_SUBNET_RO: &str = "3C 60 #BDUT_ADDR #EDI 0A 01 CF 00 00 00 10 39 00 00 01 FB";

// Secure A_PropertyExtValueRead: count=1, start=1.
// APDU: 01 CC + 00 00 + 00 10 + 39 + 01 + 00 01 = 10 bytes → len = 0x09
const SECURE_READ_SUBNET: &str = "3C 60 #EDI #BDUT_ADDR 09 01 CC 00 00 00 10 39 01 00 01";

// Secure read success: count=1, data=high byte of BDUT address.
// APDU: 01 CD + 00 00 + 00 10 + 39 + 01 + 00 01 + ?? = 11 bytes → len = 0x0A
const SECURE_READ_SUBNET_OK: &str = "3C 60 #BDUT_ADDR #EDI 0A 01 CD 00 00 00 10 39 01 00 01 ??";

// Secure read error: count=0, return_code=0xFC (E_ACCESS_DENIED).
const SECURE_READ_SUBNET_DENIED: &str = "3C 60 #BDUT_ADDR #EDI 0A 01 CD 00 00 00 10 39 00 00 01 FC";
...
const SECURE_WRITE_DEVADDR: &str = "3C 60 #EDI #BDUT_ADDR 0A 01 CE 00 00 00 10 3A 01 00 01 8A";

const SECURE_WRITE_DEVADDR_RO: &str = "3C 60 #BDUT_ADDR #EDI 0A 01 CF 00 00 00 10 3A 00 00 01 FB";

const SECURE_READ_DEVADDR: &str = "3C 60 #EDI #BDUT_ADDR 09 01 CC 00 00 00 10 3A 01 00 01";

// Secure read success: count=1, data=low byte of BDUT address.
const SECURE_READ_DEVADDR_OK: &str = "3C 60 #BDUT_ADDR #EDI 0A 01 CD 00 00 00 10 3A 01 00 01 ??";

const SECURE_READ_DEVADDR_DENIED: &str = "3C 60 #BDUT_ADDR #EDI 0A 01 CD 00 00 00 10 3A 00 00 01 FC";
...
const PLAIN_WRITE_SUBNET: &str = "BC #EDI #BDUT_ADDR 6A 01 CE 00 00 00 10 39 01 00 01 72";

// Plain write error: count=0, return_code=0xFB (E_ACCESS_READ_ONLY).
const PLAIN_WRITE_SUBNET_RO: &str = "BC #BDUT_ADDR #EDI 6A 01 CF 00 00 00 10 39 00 00 01 FB";

// Plain A_PropertyExtValueRead.
// APDU: 01 CC + 00 00 + 00 10 + 39 + 01 + 00 01 = 10 bytes → TP1 len = 0x69
const PLAIN_READ_SUBNET: &str = "BC #EDI #BDUT_ADDR 69 01 CC 00 00 00 10 39 01 00 01";

// Plain read success: count=1, data=high byte of BDUT address.
const PLAIN_READ_SUBNET_OK: &str = "BC #BDUT_ADDR #EDI 6A 01 CD 00 00 00 10 39 01 00 01 ??";

// Plain read error: count=0, return_code=0xFC (E_ACCESS_DENIED).
const PLAIN_READ_SUBNET_DENIED: &str = "BC #BDUT_ADDR #EDI 6A 01 CD 00 00 00 10 39 00 00 01 FC";

// ============================================================================
// PID_DEVICE_ADDRESS (0x3A) — Plain templates on Device Object
// ============================================================================

const PLAIN_WRITE_DEVADDR: &str = "BC #EDI #BDUT_ADDR 6A 01 CE 00 00 00 10 3A 01 00 01 8A";

const PLAIN_WRITE_DEVADDR_RO: &str = "BC #BDUT_ADDR #EDI 6A 01 CF 00 00 00 10 3A 00 00 01 FB";

const PLAIN_READ_DEVADDR: &str = "BC #EDI #BDUT_ADDR 69 01 CC 00 00 00 10 3A 01 00 01";

const PLAIN_READ_DEVADDR_OK: &str = "BC #BDUT_ADDR #EDI 6A 01 CD 00 00 00 10 3A 01 00 01 ??";

const PLAIN_READ_DEVADDR_DENIED: &str = "BC #BDUT_ADDR #EDI 6A 01 CD 00 00 00 10 3A 00 00 01 FC";
...
pub fn create_section_3_8_18_suite() -> TestSuite {
    ...
    TestSuite::new("3.8.18 PID_SUBNET_ADDR / PID_DEVICE_ADDRESS (Device Object, access 3FF/00C)", variables)
        .secure()
        .with_cases(vec![test_3_8_18_1(), test_3_8_18_2(), test_3_8_18_3()])
}
...
fn test_3_8_18_3() -> TestCase {
    TestCase::new("3.8.18.3 Write and read PID_SUBNET_ADDR/PID_DEVICE_ADDRESS unsecured").with_steps(vec![
        // ==== Security Mode ON ====
        comment("Enable Security Mode"),
        inject_secure_ac(ENABLE_SECURITY_MODE, "TK1"),
        expect_secure_ac(ENABLE_SECURITY_MODE_RESP, "TK1", TIMEOUT),
