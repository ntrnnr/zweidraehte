...
const PLAIN_DESC_READ_PID47: &str =
    "BC #EDI #BDUT_ADDR 68 01 D2 00 00 00 10 47 00 00";
...
const PLAIN_DESC_READ_PID47_OK: &str =
    "3C 60 #BDUT_ADDR #EDI 10 01 D3 00 00 00 10 47 ?? ?? ?? ?? ?? ?? ?? ?? ?? ??";
