...
const PLAIN_DESC_READ_PID05: &str = "BC #EDI #BDUT_ADDR 68 01 D2 00 11 00 10 05 00 00";

// Plain response: all-zero descriptor (denied when SM=ON, 00C policy for Security IO).
const PLAIN_DESC_READ_PID05_ZERO: &str = "3C 60 #BDUT_ADDR #EDI 10 01 D3 00 11 00 10 05 00 00 00 00 00 00 00 00 00 00";
...
pub fn create_section_3_8_7_suite() -> TestSuite {
    ...
    TestSuite::new("3.8.7 PID_LOAD_STATE_CONTROL / SIAT (Security IO)", variables).secure().with_cases(vec![
        test_3_8_7_1(),
        test_3_8_7_2(),
        test_3_8_7_3(),
        test_3_8_7_4(),
...
fn test_3_8_7_4() -> TestCase {
    ...
    // 3.8.7.4 runs.
    const START_LOADING: &str = "3C 60 #EDI #BDUT_ADDR 13 01 CE 00 11 00 10 05 01 00 01 01 00 00 00 00 00 00 00 00 00";
    const LOAD_COMPLETED: &str = "3C 60 #EDI #BDUT_ADDR 13 01 CE 00 11 00 10 05 01 00 01 02 00 00 00 00 00 00 00 00 00";
    const LOAD_CONTROL_OK: &str = "3C 60 #BDUT_ADDR #EDI 0A 01 CF 00 11 00 10 05 01 00 01 00";

    const READ_LOAD_STATE: &str = "3C 60 #EDI #BDUT_ADDR 09 01 CC 00 11 00 10 05 01 00 01";
    const READ_LOAD_STATE_LOADED: &str = "3C 60 #BDUT_ADDR #EDI 0A 01 CD 00 11 00 10 05 01 00 01 01";
    ...
    TestCase::new("3.8.7.4 Secure PropertyValueRead after power down check value").with_steps(steps)
}
