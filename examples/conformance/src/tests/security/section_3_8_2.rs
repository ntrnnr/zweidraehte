...
const PLAIN_READ_PID02: &str =
    "BC #EDI #BDUT_ADDR 69 01 CC 00 11 00 10 02 0F 00 01";

// Plain error response: count=0, return_code=0xFC (E_ACCESS_DENIED).
// APDU: 01 CD + 00 11 + 00 10 + 02 + 00 + 00 01 + FC = 11 bytes → TP1 len = 0x6A
const PLAIN_READ_PID02_DENIED: &str =
    "BC #BDUT_ADDR #EDI 6A 01 CD 00 11 00 10 02 00 00 01 FC";
...
const SECURE_READ_PID02: &str =
    "3C 60 #EDI #BDUT_ADDR 09 01 CC 00 11 00 10 02 0F 00 01";

// Secure error response: count=0, return_code=0xFC.
const SECURE_READ_PID02_DENIED: &str =
    "3C 60 #BDUT_ADDR #EDI 0A 01 CD 00 11 00 10 02 00 00 01 FC";
...
const PLAIN_WRITE_PID02: &str =
    "3C 60 #EDI #BDUT_ADDR 13 01 CE 00 11 00 10 02 0F 00 01 00 00 00 00 00 00 00 00 00 00";
...
const PLAIN_WRITE_PID02_RO: &str =
    "BC #BDUT_ADDR #EDI 6A 01 CF 00 11 00 10 02 00 00 01 ??";

// Secure WriteCon template.
const SECURE_WRITE_PID02: &str =
    "3C 60 #EDI #BDUT_ADDR 13 01 CE 00 11 00 10 02 0F 00 01 00 00 00 00 00 00 00 00 00 00";

// Secure write error response: return_code wildcard.
const SECURE_WRITE_PID02_RO: &str =
...
pub fn create_section_3_8_2_suite() -> TestSuite {
    ...
    TestSuite::new("3.8.2 PID_OBJECT_NAME (Security IO, access 3FF/0CC) [optional]", variables)
        .secure()
        .with_cases(vec![
