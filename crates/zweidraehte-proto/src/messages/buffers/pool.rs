...
//! and [`DynBufferManager`]. Freed buffers travel back to the pool
//! through an embassy channel, which is why this whole module sits
//! behind the `buffer-pool` feature.
