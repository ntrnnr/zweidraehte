//! Standard interface-object Property IDs (03/05/01 Resources,
//! 03/07/03 Standardized Identifier Tables).
//!
//! Pure wire constants: the same PIDs a device serves and a management
//! client reads or writes, so they live here rather than in either
//! side's crate. General PIDs (1–50) apply to every interface object;
//! the nested modules carry the object-type-specific ranges.
//!
