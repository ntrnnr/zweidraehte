...
//!
//! ```rust,ignore
//! use zweidraehte_ets_files::{Device, parse_application_program_from_file};
//!
...
impl Device {
    ...
    pub fn new(program: ApplicationProgram, baggage_index: Option<BaggageIndex>) -> Self {
        // Build lookup caches
...
/// Mutable products of one visibility fixpoint iteration.
///
