...
///
/// Two layers of a device stack re-expose the same accessor traits by
/// forwarding every method to a field:
///
/// - **The device state** (`SystemBDeviceState`, `System7DeviceState`)
///   re-exposes the extension's accessor traits by
