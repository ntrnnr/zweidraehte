...
use crate::objects::tables::{
    AbsoluteAlloc, Application, Table, TableMemory, addr8::AddrTab8Impl, asso8::AssoTab8Impl, co7::CoTab7Impl,
};
...
/// - `COT_SIZE`: group object table size (2 + MAX_CO * 2)
...
> {
    ...
    pub group_object_table: Table<CoTab7Impl<COT_SIZE>, AbsoluteAlloc>,
