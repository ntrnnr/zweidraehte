...
mod tests {
    ...
    /// Sanity check: the published reflected CRC-32 of the ASCII
    /// string "123456789" is 0xCBF43926. If this drifts we have broken
    /// either the table generator or the update step.
    #[test]
