...
pub const DEFAULT_CONFIG: [u8; 32] = [
    0x12, 0xA0, 0x06, 0x06, 0x0C, 0xC1, 0x59, 0x3D, 0x3D, 0x59, 0x3D, 0x3D, 0x20, 0xF9, 0x19, 0x00, 0x75, 0x38, 0x70,
    0x07, 0x00, 0x00, 0x54, 0x76, 0x96, 0x00, 0x40, 0x1C, 0x00, 0x00, 0x40, 0x00,
];
