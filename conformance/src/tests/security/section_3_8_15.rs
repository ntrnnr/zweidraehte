...
const PLAIN_READ: &str = "BC #EDI #BDUT_ADDR 69 01 CC 00 11 00 10 3B 01 00 01";

// Plain read denied: count=0, return_code=0xFC.
const PLAIN_READ_DENIED: &str = "BC #BDUT_ADDR #EDI 6A 01 CD 00 11 00 10 3B 00 00 01 FC";
...
const PLAIN_WRITE: &str = "3C 60 #EDI #BDUT_ADDR 0F 01 CE 00 11 00 10 3B 01 00 01 00 00 00 00 00 00";

// Plain write denied: count=0, return_code=0xFC.
// APDU: 11 bytes → TP1 standard frame len = 0x6A
const PLAIN_WRITE_DENIED: &str = "BC #BDUT_ADDR #EDI 6A 01 CF 00 11 00 10 3B 00 00 01 FC";
...
const SECURE_READ: &str = "3C 60 #EDI #BDUT_ADDR 09 01 CC 00 11 00 10 3B 01 00 01";

// Secure read denied: count=0, return_code=0xFC.
const SECURE_READ_DENIED: &str = "3C 60 #BDUT_ADDR #EDI 0A 01 CD 00 11 00 10 3B 00 00 01 FC";

// Secure A write: count=1, start=1, data=6 zero bytes.
const SECURE_WRITE: &str = "3C 60 #EDI #BDUT_ADDR 0F 01 CE 00 11 00 10 3B 01 00 01 00 00 00 00 00 00";

// Secure write denied.
const SECURE_WRITE_DENIED: &str = "3C 60 #BDUT_ADDR #EDI 0A 01 CF 00 11 00 10 3B 00 00 01 FC";
...
const SECURE_DESC_READ: &str = "3C 60 #EDI #BDUT_ADDR 08 01 D2 00 11 00 10 3B 00 00";

// Secure A+C success response: valid descriptor (wildcard data bytes).
const SECURE_DESC_READ_OK: &str = "3C 60 #BDUT_ADDR #EDI 10 01 D3 00 11 00 10 3B ?? ?? ?? ?? ?? ?? ?? ?? ?? ??";

// Plain description read.
const PLAIN_DESC_READ: &str = "BC #EDI #BDUT_ADDR 68 01 D2 00 11 00 10 3B 00 00";

// Plain all-zero descriptor (00C/00C: plain NEVER allowed).
const PLAIN_DESC_READ_ZERO: &str = "3C 60 #BDUT_ADDR #EDI 10 01 D3 00 11 00 10 3B 00 00 00 00 00 00 00 00 00 00";
...
fn test_3_8_15_3() -> TestCase {
    ...
    const WRITE_SEQ: &str = "3C 60 #EDI #BDUT_ADDR 0F 01 CE 00 11 00 10 3B 01 00 01 00 00 00 00 1F 32";
    const WRITE_SEQ_OK: &str = "3C 60 #BDUT_ADDR #EDI 0A 01 CF 00 11 00 10 3B 01 00 01 00";
    ...
    const READ_SEQ_OK_AFTER_PWR: &str = "3C 60 #BDUT_ADDR #EDI 0F 01 CD 00 11 00 10 3B 01 00 01 00 00 00 00 ?? ??";
...
fn test_3_8_15_8() -> TestCase {
    ...
    const CONNECTED_WRITE_ZERO: &str = "3C 60 #EDI #BDUT_ADDR 0F 41 CE 00 11 00 10 3B 01 00 01 00 00 00 00 00 00";
    ...
    const CONNECTED_WRITE_DENIED: &str = "3C 60 #BDUT_ADDR #EDI 0A 41 CF 00 11 00 10 3B 00 00 01 F?";
...
fn test_3_8_15_1() -> TestCase {
    ...
    const WRITE_SEQ_1F00: &str = "3C 60 #EDI #BDUT_ADDR 0F 01 CE 00 11 00 10 3B 01 00 01 00 00 00 00 1F 00";
    const WRITE_SEQ_1F00_OK: &str = "3C 60 #BDUT_ADDR #EDI 0A 01 CF 00 11 00 10 3B 01 00 01 00";

    // Read PID 0x3B, expect 0x000000001F01 (written + 1).
    const READ_SEQ: &str = "3C 60 #EDI #BDUT_ADDR 09 01 CC 00 11 00 10 3B 01 00 01";
    const READ_SEQ_1F01: &str = "3C 60 #BDUT_ADDR #EDI 0F 01 CD 00 11 00 10 3B 01 00 01 00 00 00 00 1F 01";
...
fn test_3_8_15_6() -> TestCase {
    ...
    const WRITE_SEQ_MAX_MINUS_1: &str = "3C 60 #EDI #BDUT_ADDR 0F 01 CE 00 11 00 10 3B 01 00 01 FF FF FF FF FF FE";
    const WRITE_SEQ_OK: &str = "3C 60 #BDUT_ADDR #EDI 0A 01 CF 00 11 00 10 3B 01 00 01 00";
...
fn test_3_8_15_7() -> TestCase {
    ...
    // (below threshold).
    const CO_WRITE_BELOW_FC: &str = "30 60 #EDI #BDUT_ADDR 0F 41 CE 00 11 00 10 3B 01 00 01 FE FF FF FF FF FC";
    const CO_WRITE_BELOW_FD: &str = "30 60 #EDI #BDUT_ADDR 0F 41 CE 00 11 00 10 3B 01 00 01 FE FF FF FF FF FD";
    const CO_WRITE_OK: &str = "30 60 #BDUT_ADDR #EDI 0A 41 CF 00 11 00 10 3B 01 00 01 00";
    const CO_WRITE_OK_RESET: &str = "30 60 #BDUT_ADDR_RESET #EDI 0A 41 CF 00 11 00 10 3B 01 00 01 00";

    // Connection-oriented A+C write of SeqNb = FF 00 00 00 00 00
    // (at threshold — the spec's switchover point).
    const CO_WRITE_AT_THRESHOLD: &str = "30 60 #EDI #BDUT_ADDR 0F 41 CE 00 11 00 10 3B 01 00 01 FF 00 00 00 00 00";
    ...
    const UC_READ: &str = "3C 60 #EDI #BDUT_ADDR 09 01 CC 00 11 00 10 3B 01 00 01";
    // Same but inside a connection (seen across the destructive-reset
    // re-read after sync). Uses TPCI 0x41 = numbered(seq 0) per spec.
    const CO_READ: &str = "30 60 #EDI #BDUT_ADDR 09 41 CC 00 11 00 10 3B 01 00 01";
    const CO_READ_RESET: &str = "30 60 #EDI #BDUT_ADDR_RESET 09 41 CC 00 11 00 10 3B 01 00 01";
    ...
    const UC_READ_OK: &str = "3C 60 #BDUT_ADDR #EDI 0F 01 CD 00 11 00 10 3B 01 00 01 ?? ?? ?? ?? ?? ??";
    // Connected-response TPCI is 0x41 (numbered seq 0 — mirrors request seq).
    const CO_READ_OK: &str = "30 60 #BDUT_ADDR #EDI 0F 41 CD 00 11 00 10 3B 01 00 01 ?? ?? ?? ?? ?? ??";
    ...
    TestCase::new("3.8.15.7 Master Reset tests").with_steps(steps).with_teardown(provision_tk1_via_fdsk())
}
