...
pub struct Stm32G0LightSwitchDefinition;

pub type Stm32G0LightSwitch = Tp1<Stm32G0LightSwitchDefinition>;
type Stm32G0State = <Stm32G0LightSwitch as StackDefinition>::State;
...
pub struct Stm32G0LightSwitchHooks;

impl DeviceHooks for Stm32G0LightSwitchHooks {
...
impl DeviceDefinition for Stm32G0LightSwitchDefinition {
    ...
    type Hooks = Stm32G0LightSwitchHooks;
}
